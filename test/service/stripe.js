...
test('Can post a charge', async (t) => {
  ...
  .replyContentLength()
  .replyDate()
  .post('/v1/charges', 'amount=100&currency=USD&description=Purchase%20of%20com.github.btkostner.vocal&source=tok_489z4f23g89489344g894d9a&destination%5Baccount%5D=acct_j8930zj093jfASDF&destination%5Bamount%5D=50')
